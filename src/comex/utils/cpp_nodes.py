...
statement_types = {
    ...
    + control_statements
    + ["method_declaration", "function_definition"#"local_function_statement"
       ],
...
def abstract_method(node):
    ...
    method_body = get_child_of_type(node, ["compound_statement"])
        ...
        if (
            ...
            if root_node.type in [
                ...
                for child in root_node.children:
                    if child.type != "compound_statement" and child.type != "constructor_body":
